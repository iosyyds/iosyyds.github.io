...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),b=e("code",null,"8000端口",-1),f={href:"https://casdoor.org/zh/docs/basic/server-installation#%E9%80%9A%E8%BF%87-ini-%E6%96%87%E4%BB%B6%E9%85%8D%E7%BD%AE",target:"_blank",rel:"noopener noreferrer"},y=i(`<p>casdoor默认使用的是<strong>MySQL</strong>数据库，如果你也是使用<strong>MySQL</strong>可以按照以下格式填写,应该看得懂什么意思 实在不懂可以评论区问问</p><div class="language-conf line-numbers-mode" data-ext="conf" data-title="conf"><pre class="language-conf"><code>	......
driverName = mysql
dataSourceName = root:123123@tcp(localhost:3306)/
dbName = casdoor
	......
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到这里基本上结束了，可以去愉快的给<code>应用</code>接入登录了</p><br><p>那里不清楚大家可以留言 会回复的。</p>`,5);function N(B,E){const s=t("ExternalLinkIcon");return d(),l("div",null,[u,p,e("p",null,[n("官网推荐使用 "),e("a",v,[n("Yarn 1.x"),a(s)]),n(" 运行 & Casdoor 前端，使用 NPM可能会导致UI 风格问题。 更多详细信息见： "),e("a",m,[n("Casdoor#294"),a(s)])]),e("p",null,[n("然后我们将开源代码下载下来，或者使用 "),e("a",h,[n("Git Bash"),a(s)]),n(" clone到本地")]),g,e("p",null,[n("配置文件所有参数的作用我这里细说了,下面我只说一下如何配置数据库和"),b,n("是做什么的吧"),e("a",f,[n("详情查看Casdoor官网"),a(s)])]),y,e("p",null,[n("还有更多的数据库用法，有需要的可以前往"),e("a",_,[n("Casdoor官网"),a(s)]),n("看看")]),x,e("p",null,[n("输入"),k,n("启动后等待一会儿，就会自动打开一个浏览器 "),e("a",q,[n("http://localhost:7001/"),a(s)])]),C])}const D=o(c,[["render",N],["__file","dev.html.vue"]]),P=JSON.parse('{"path":"/index/build/sso/dev.html","title":"在线调试Cadoor","lang":"zh-CN","frontmatter":{"title":"在线调试Cadoor","icon":"fa-solid fa-rectangle-terminal","order":122,"author":"安稳","date":"2023-01-01T00:00:00.000Z","category":["使用指南"],"tag":["自己编译","Dev","在线调试","Cadoor"],"sticky":true,"star":true,"headerDepth":6,"collapsible":false,"description":"开发须知 开发Cadoor需要使用 Go > 1.17+，Node.js ≥ 14&16，Yarn 1.x 版本 官网推荐使用 Yarn 1.x 运行 & Casdoor 前端，使用 NPM可能会导致UI 风格问题。 更多详细信息见： Casdoor#294 然后我们将开源代码下载下来，或者使用 Git Bash clone到本地 然后我们打开开发工具...","head":[["meta",{"property":"og:url","content":"https://iosyyds/iosyyds.github.io/index/build/sso/dev.html"}],["meta",{"property":"og:site_name","content":"甜甜"}],["meta",{"property":"og:title","content":"在线调试Cadoor"}],["meta",{"property":"og:description","content":"开发须知 开发Cadoor需要使用 Go > 1.17+，Node.js ≥ 14&16，Yarn 1.x 版本 官网推荐使用 Yarn 1.x 运行 & Casdoor 前端，使用 NPM可能会导致UI 风格问题。 更多详细信息见： Casdoor#294 然后我们将开源代码下载下来，或者使用 Git Bash clone到本地 然后我们打开开发工具..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://iosyyds/iosyyds.github.io/img/sso/dev/cmd.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-08-20T10:05:34.000Z"}],["meta",{"property":"article:author","content":"安稳"}],["meta",{"property":"article:tag","content":"自己编译"}],["meta",{"property":"article:tag","content":"Dev"}],["meta",{"property":"article:tag","content":"在线调试"}],["meta",{"property":"article:tag","content":"Cadoor"}],["meta",{"property":"article:published_time","content":"2023-01-01T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-08-20T10:05:34.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"在线调试Cadoor\\",\\"image\\":[\\"https://iosyyds/iosyyds.github.io/img/sso/dev/cmd.png\\"],\\"datePublished\\":\\"2023-01-01T00:00:00.000Z\\",\\"dateModified\\":\\"2024-08-20T10:05:34.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"安稳\\"}]}"]]},"headers":[{"level":2,"title":"开发须知","slug":"开发须知","link":"#开发须知","children":[]},{"level":2,"title":"casdoor配置文件","slug":"casdoor配置文件","link":"#casdoor配置文件","children":[{"level":4,"title":"先启动后端","slug":"先启动后端","link":"#先启动后端","children":[]},{"level":4,"title":"再启动前端","slug":"再启动前端","link":"#再启动前端","children":[]}]}],"git":{"createdTime":1724148334000,"updatedTime":1724148334000,"contributors":[{"name":"甜甜","email":"145662294+iosyyds@users.noreply.github.com","commits":1}]},"readingTime":{"minutes":2.06,"words":619},"filePathRelative":"index/build/sso/dev.md","localizedDate":"2023年1月1日","autoDesc":true,"excerpt":"<!-- 你可以通过设置页面的 Frontmatter，在页面禁用功能与布局。 -->\\n"}');export{D as comp,P as data};
